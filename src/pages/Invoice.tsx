      ...
      >
        ...
        <div className="px-8 py-5 border-b border-line/60 grid grid-cols-2 gap-4">
          <div>
            ...
            <p className="font-sans text-sm text-ink">___________________________</p>
          </div>
          <div>
            <p className="text-xs font-sans uppercase tracking-widest text-ink-soft font-medium mb-1">
              Ciudad
          ...
          <table className="w-full text-sm font-sans">
            <thead>
              <tr className="border-b border-line">
                <th className="text-left text-xs uppercase tracking-widest text-ink-soft font-medium pb-3">
                  Producto
                </th>
                <th className="text-center text-xs uppercase tracking-widest text-ink-soft font-medium pb-3">
                  Cant.
                </th>
                <th className="text-right text-xs uppercase tracking-widest text-ink-soft font-medium pb-3">
                  Precio
                </th>
                <th className="text-right text-xs uppercase tracking-widest text-ink-soft font-medium pb-3">
                  Total
            ...
            <tbody className="divide-y divide-line/50">
              {items.length > 0 ? (
                  ...
                  return (
                    <tr key={`${item.product.id}-${item.colorSlug}`}>
                      <td className="py-3 pr-4">
                        ...
                        {color && (
                          <p className="text-ink-soft text-xs mt-0.5">{color.name}</p>
                        )}
                      </td>
                ...
                // Empty state rows for printing
                [1, 2, 3].map(n => (
                  <tr key={n}>
                    <td className="py-4 pr-4">
                      <div className="h-4 bg-line/30 rounded w-48" />
                    </td>
                    <td className="py-4 text-center">
                      <div className="h-4 bg-line/30 rounded w-6 mx-auto" />
                    </td>
                    <td className="py-4 text-right">
                      <div className="h-4 bg-line/30 rounded w-20 ml-auto" />
                    </td>
                    <td className="py-4 text-right">
                      <div className="h-4 bg-line/30 rounded w-24 ml-auto" />
                    </td>
                  </tr>
                ))
              )}
