...
const LINKS_TIENDA = [
  ...
  { to: '/tienda?categoria=scrunchies', label: 'Scrunchies' },
  { to: '/tienda?categoria=combo-descanso', label: 'Combos Descanso' },
  { to: '/tienda?modo=mayor', label: 'Por Mayor' },
]

const LINKS_INFO = [
  { to: '/como-comprar', label: 'Cómo comprar' },
  { to: '/envios', label: 'Envíos y tiempos' },
  { to: '/preguntas-frecuentes', label: 'Preguntas frecuentes' },
  { to: '/politica-devoluciones', label: 'Devoluciones' },
]
